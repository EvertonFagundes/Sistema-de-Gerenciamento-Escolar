...
public class Aluno extends Usuario {
    ...
    public Aluno(String nome, String cpf, String rg, String matricula, String email, int diaNasc, int mesNasc, int anoNasc,String nomeRua, String nomeBairro, String nomeCidade, int numeroCasa, String complemento, int numeroTelefone, String senha, String situacao, String nomeResponsavel, int telefoneResponsavel, String emailResponsavel){
